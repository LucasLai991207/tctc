...
function Load_Player_Leaderboard() {
    ...
    const has_firebase_functions = typeof Get_Top_Players_By_Avg_Wpm === "function"
        ...
        && typeof Get_Top_Players_By_Streak === "function"
        && typeof Get_Top_Players_By_Total_Login_Days === "function"
        && typeof Get_All_Player_Stats_For_Achievement_Level === "function"
        && typeof Get_Top_Players_By_XP === "function"
...
function Load_Own_Achievement_Level_Rank() {
    ...
    Get_All_Player_Stats_For_Achievement_Level(function (list) {
        ...
        if (!own_entry || own_entry._achv_level < 1) return
...
function Load_Own_Player_Rank() {
    ...
    Get_Own_Player_Rank(order_by_field, min_count_field, min_count, function (result) {
        ...
        else if (player_metric === "streak_longest") value_text = `連續 ${result.value ?? 0} 天`
        else if (player_metric === "streak_total_days") value_text = `${result.value ?? 0} 天`
        else if (player_metric === "xp") {
